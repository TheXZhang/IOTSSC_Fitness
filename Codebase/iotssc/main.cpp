...
static M2MResource* m2m_gyro_x;
static M2MResource* m2m_gyro_y;
static M2MResource* m2m_gyro_z;

static M2MResource* m2m_accelero_x;
static M2MResource* m2m_accelero_y;
static M2MResource* m2m_accelero_z;

static M2MResource* m2m_megneto_x;
static M2MResource* m2m_megneto_y;
static M2MResource* m2m_megneto_z;
...
void update_readings(){
    ...
    m2m_gyro_x->set_value(pGyroDataXYZ[0]);
    m2m_gyro_y->set_value(pGyroDataXYZ[1]);
    m2m_gyro_z->set_value(pGyroDataXYZ[2]);

    m2m_accelero_x->set_value(pAccDataXYZ[0]);
    m2m_accelero_y->set_value(pAccDataXYZ[1]);
    m2m_accelero_z->set_value(pAccDataXYZ[2]);

    m2m_megneto_x->set_value(pMagDataXYZ[0]);
    m2m_megneto_y->set_value(pMagDataXYZ[1]);
    m2m_megneto_z->set_value(pMagDataXYZ[2]);
...
int main(void)
{
  ...
  m2m_gyro_x = M2MInterfaceFactory::create_resource(m2m_obj_list, 3334, 0, 5702, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
  m2m_gyro_y = M2MInterfaceFactory::create_resource(m2m_obj_list, 3334, 0, 5703, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
  m2m_gyro_z = M2MInterfaceFactory::create_resource(m2m_obj_list, 3334, 0, 5704, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);

  m2m_accelero_x = M2MInterfaceFactory::create_resource(m2m_obj_list, 3313, 0, 5702, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
  m2m_accelero_y = M2MInterfaceFactory::create_resource(m2m_obj_list, 3313, 0, 5703, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
  m2m_accelero_z = M2MInterfaceFactory::create_resource(m2m_obj_list, 3313, 0, 5704, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);

  m2m_megneto_x = M2MInterfaceFactory::create_resource(m2m_obj_list, 3314, 0, 5702, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);
  m2m_megneto_y = M2MInterfaceFactory::create_resource(m2m_obj_list, 3314, 0, 5703, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED); 
  m2m_megneto_z = M2MInterfaceFactory::create_resource(m2m_obj_list, 3314, 0, 5704, M2MResourceInstance::STRING, M2MBase::GET_ALLOWED);    
